...
async def process_start_command(message:Message):
    keyboard:list[list[InlineKeyboardButton]]=[[InlineKeyboardButton(text='Хочу ещё!',callback_data='more')]]
...
#================================= 1 Способ =====================================
# Этот хэндлер будет срабатывать на нажатие кнопки "Хочу еще!",но с обработкой повторов
@dp.callback_query(F.data == 'more')
async def process_more_press(callback: CallbackQuery):
