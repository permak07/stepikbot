...
# get_data - возвращает словарь с данными контекста.
# update_data - отвечает за обновление данных в словаре контекста. Если ключи совпадают - значения по ним обновляются, а если не совпадают - пары ключ-значение добавляются в словарь контекста.
# clear - стирает контекст. Состояние устанавливается в None, а словарь с данными контекста очищается.